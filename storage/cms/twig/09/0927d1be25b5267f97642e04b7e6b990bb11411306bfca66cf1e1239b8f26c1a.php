...
class __TwigTemplate_294f33066108b31c05a2962c67016b5876b496e32823c1cc727c07a3ed74a40d extends Twig_Template
{
...
<div class=\"container\">
    <div id=\"header-topbar\">
        ...
        <ul id=\"slide-out\" class=\"side-nav\">
            <li class=\"";
        // line 23
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "kezdolap")) {
            echo "active";
        }
        echo "\"><a href=\"";
        echo $this->env->getExtension('Cms\Twig\Extension')->pageFilter("hirek/kezdolap");
        echo "\">Főoldal</a></li>
            <li class=\"";
        // line 24
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "bemutatkozas")) {
            echo "active";
        }
        echo "\"><a href=\"";
                    ...
                    <li>
                        ...
                        <div class=\"collapsible-body\">
                            <ul class=\"mobil-submenu\">
                                <li class=\"";
        // line 31
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "suni-csoport")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Süni</a></li>
                                ...
                                <li class=\"";
        // line 33
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "ozike-csoport")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Őzike</a></li>
                                ...
                                <li class=\"";
        // line 35
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "nyuszi-csoport")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Nyuszi</a></li>
            ...
            <li class=\"";
        // line 42
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "dokumentumok")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Dokumentumok</a></li>
            <li class=\"";
        // line 43
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "programok")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Programok</a></li>
            <li class=\"";
        // line 44
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "kepgaleria")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Képgaléria</a></li>
            <li class=\"";
        // line 45
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "ajanlo")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Ajánló</a></li>
            <li class=\"";
        // line 46
        if (($this->getAttribute($this->getAttribute(($context["this"] ?? null), "page", array()), "id", array()) == "kapcsolat")) {
            echo "active";
        }
        echo "\"><a href=\"";
